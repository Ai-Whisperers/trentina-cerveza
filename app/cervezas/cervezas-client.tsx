...
import { ChevronDown, Beer, Wine, GlassWater, FlaskConical, Citrus, Leaf, Wheat, IceCreamCone } from "lucide-react";
...
export default function MenuPageClient({
  ...
  const catIcons: Record<string, React.ReactNode> = {
    ipa: <Beer size={18} />,
    lager: <Wine size={18} />,
    stout: <GlassWater size={18} />,
    porter: <FlaskConical size={18} />,
    paleAle: <Citrus size={18} />,
    witbier: <Leaf size={18} />,
    redAle: <Wheat size={18} />,
    barleywine: <IceCreamCone size={18} />,
    sessionIpa: <Beer size={18} />,
    belgian: <Wine size={18} />,
    wheat: <Leaf size={18} />,
    dark: <GlassWater size={18} />,
    sour: <Citrus size={18} />,
    special: <FlaskConical size={18} />,
  };
